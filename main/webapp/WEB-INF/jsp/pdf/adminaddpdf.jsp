...
<div>   
 <div id="loadDiv">        
 <div id="gif">            
 <img style="padding: 10px" src="Assets/images/wait.gif" _height="64" _width="64">        
  </div>        <div id="gifText" >           
...
<div>
图书名称： <input type="text" name="fname" id="fname"/>
图书积分： <input type="text" name="lname" id="lname">
...
<div><form action="toImagepdf" method="" id="forms">
