...
<body>
        <iframe id="topframe" src="admintop" name="topframe" scrolling="no" frameborder="no" border="0"></iframe>
        <iframe id="topbar" src="adminTopSwitch" name="topSwitchFrame" scrolling="no" frameborder="no" border="0"></iframe>
       	...
       	<iframe id="rightFrame" name="mainFrame" src="adminmain" frameborder="no" border="0"></iframe>
 	<script>
