...
<body onselectstart="return false;" ondragstart="return false;"
	...
	<div style="float: left" id="my_menu" class="sdmenu">
		...
		<div>
			<span>任务管理</span> 
			<a href="${pageContext.request.contextPath }/pdfrenwu?flagPage=0" target="mainFrame" onFocus="this.blur()">任务发布</a> 
			<a href="${pageContext.request.contextPath }/pdfrenwu?flagPage=1" target="mainFrame" onFocus="this.blur()">任务分配</a>
			<a href="${pageContext.request.contextPath }/pdfrenwu?flagPage=2" target="mainFrame" onFocus="this.blur()">已分配任务查询与修改</a>
			<a href="${pageContext.request.contextPath }/pdfrenwu?flagPage=3" target="mainFrame" onFocus="this.blur()">任务校验</a>
		</div>
		<div>
