...
<html>
	...
	<body>
		...
		<a class="btn btn-primary" role="button"  id="taskGet" href="${pageContext.request.contextPath }/taskGet?flag=1&bookId=${bookId}">${manageFlag == '0' ? '领取任务':'放弃任务' }</a>
		<script src="layui/layui.js" charset="utf-8"></script>
		...
		function changename(){
			if('${manageFlag}'=='0')
			{
				document.getElementById("taskGet").value="领取任务";
			}else
				{
				document.getElementById("taskGet").value="放弃任务";
				}
		...
		*/
			...
			eg.showThumb = function(group) {
				...
				for(var i = start;
					...
					li.innerHTML = '<img src="' + eg.rootUrl + eg.data[i].url + '" class="init" id="thumb_' + (i+1) + '" alt="" width="128" height="57" ' + 
                ...
                if(this.title=="1"){
                	...
                	layer.open({
                		...
                		,yes:function(){
                			...
                			window.location.href="${pageContext.request.contextPath }/afterwardRecognized?flagpdf=1&photoSrc="
