...
<body>
 		<iframe id="topframe" src="head" name="topframe" scrolling="no" frameborder="no" border="0"></iframe>
        <iframe id="topbar" src="adminTopSwitch" name="topSwitchFrame" scrolling="no" frameborder="no" border="0"></iframe>
       	<iframe id="leftFrame" src="personleft" frameborder="no" border="0"></iframe>
       	<iframe id="leftbar" name="switchFrame" src="adminswitch" frameborder="no" border="0"></iframe>
       	<iframe id="rightFrame" name="mainFrame" src="personmain" frameborder="no" border="0"></iframe>
 	<script>
...
<!-- <frameset rows="95,*,30" cols="*" frameborder="no" border="0"
	framespacing="0">
	top样式
	<frame src="head" name="topframe" scrolling="no" noresize
		id="topframe" title="topframe" ></frame>
	contact样式
